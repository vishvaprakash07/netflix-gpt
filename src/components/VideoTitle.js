...
const VideoTitle = (props) => {
    ...
    const handlePlayButton = () => {
        dispatch(setNowPlayingTrailer({
            isNowPlayingTrailer: true,
            nowPlayingTrailerId: movie?.id,
        }));
    }
    ...
    return (
        <div className="w-screen aspect-video pt-[15%] px-6 md:px-24 absolute top-0 text-white bg-gradient-to-r from-black">
            ...
            <div className="">
                <button onClick={handlePlayButton} className="bg-white text-black px-4 md:px-16 py-2 md:py-4 rounded-lg mr-4 hover:bg-opacity-80"> Play</button>
