  ...
  return (
    <div className='pt-[40%] md:pt-[10%] flex justify-center'>
        <form className='w-full md:w-1/2 bg-black grid grid-cols-12' onSubmit={(e) => e.preventDefault()}>
            <input ref={searchText} type='text' className='p-4 m-4 col-span-9 text-sm md:text-lg' placeholder={lang[langKey].gptSearchPlaceholder} />
            <button className='py-2 px-4 m-2 md:m-4 bg-red-700 text-white text-sm md:text-lg rounded-lg col-span-3'
